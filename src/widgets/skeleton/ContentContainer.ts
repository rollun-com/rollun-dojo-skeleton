...
import theme from '../../../node_modules/@dojo/themes/dojo'
    ...
    protected render() {
        const data = [
            ...
            {order: 5, name: 'chocolate chips', description: 'Add chocolate chips'},
            {
                order: 6,
                name: 'make balls',
                description: 'Scoop up a golf ball size amount of dough with a spoon and drop it onto a cookie sheet'
            },
            {order: 7, name: 'bake', description: 'Put the cookies in the oven and bake for about 10-14 minutes'},
            {
                order: 8,
                name: 'remove',
                description: 'Using a spatula, lift cookies off onto wax paper or a cooling rack'
            },
        ...
        const columnConfig = [
            {
                id: 'order',
                title: 'Step #' // use a custom column name
            },
            {
                id: 'name',
                title: 'Name' // use a custom column name

            },
            {
                id: 'description',
                title: 'Description' // use a custom column name
            }
        ];
